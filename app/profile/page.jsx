    ...
    <section className='bg-blue-50'>
      <div className='container m-auto py-24'>
        <div className='bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0'>
          <h1 className='text-3xl mt-4 ml-4 font-bold mb-4'>Your Profile:</h1>
          <div className='flex flex-col md:flex-row'>
            <div className='ml-0 md:ml-6 mb-8 lg:ml-9 md:mr-6 mx-20 mt-4'>
              <div className='mb-4'>
                <Image
            ...
            <div className='md:w-3/4 md:pl-4 md:mr-6'>
